async function StreamBnr() {
    try {
        ...
        document.querySelector("#primeSwiper-wrapper").insertAdjacentHTML("afterbegin",streambnr.join(" "));
        

    } catch (error) {
        console.log(error.message);
    }
    var swiper = new Swiper("#primeSwiper", {
      slidesPerView: 6,
      spaceBetween: 30,
      pagination: {
        el: "#primeSwiper-pagination",
        clickable: true,
      },
      navigation: {
        nextEl: "#primeSwiper-next",
        prevEl: "#primeSwiper-prev",
      },
      breakpoints:{
        0:{
          slidesPerView:2,
