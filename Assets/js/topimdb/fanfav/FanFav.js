async function FanFav() {
    try {
        ...
        document.querySelector("#favSwiper-wrapper").insertAdjacentHTML("afterbegin",fanfav.join(" "));
    ...
    var swiper = new Swiper("#favSwiper", {
      ...
      spaceBetween: 30,
      pagination: {
        el: "#favSwiper-pagination",
        clickable: true,
      },
      navigation: {
        nextEl: "#favSwiper-next",
        prevEl: "#favSwiper-prev",
      },
      breakpoints:{
        0:{
          slidesPerView:2,
